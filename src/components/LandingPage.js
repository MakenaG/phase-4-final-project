      ...
      <div id="carouselExampleCaptions" className="carousel slide">
        ...
        <div className="carousel-inner">
          <div className="carousel-item active">
            <img src="https://pixabay.com/illustrations/photo-manipulation-alien-foreign-1825450/" className="d-block w-100" alt="Placeholder Image"/>
          ...
          <div className="carousel-item">
            <img src="https://via.placeholder.com/800x400" className="d-block w-100" alt="Placeholder Image"/>
            <div className="carousel-caption d-none d-md-block">
